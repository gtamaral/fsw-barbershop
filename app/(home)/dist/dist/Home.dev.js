    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , next_auth_1.getServerSession(route_1.authOptions)];
        ...
        case 3:
          ...
          React.createElement("div", null, React.createElement(header_1["default"], null), React.createElement("div", {
          ...
          }, "Ol\xE1, Rodrigo!"), React.createElement("p", {
            ...
            className: "text-xs mb-3 uppercase text-gray-400 font-bold"
          }, "Agendamentos"), bookings.map(function (booking) {
            React.createElement(booking_item_1["default"], {
              key: booking.id,
              booking: booking
            });
          }), "console.log(bookings)"), React.createElement("div", {
            className: "mt-6"
          }, React.createElement("h2", {
