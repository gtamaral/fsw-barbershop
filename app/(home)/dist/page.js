...
function Home() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.db.barbershop.findMany({})];
                case 1:
                    barbershops = _a.sent();
                    return [2 /*return*/, (
                        ...
                        React.createElement("div", null,
                            ...
                            React.createElement("div", { className: "mt-6 mb-[4.5rem]" },
                                React.createElement("h2", { className: "text-xs px-5 mb-3 uppercase text-gray-400 font-bold" }, "Populares"),
                                React.createElement("div", { className: "flex gap-2 px-5 overflow-x-auto [&::-webkit-scrollbar]:hidden" }, barbershops.map(function (barbershop) { return (React.createElement(barbershop_item_1["default"], { key: barbershop.id, barbershop: barbershop })); })))))];
            }
        });
    });
